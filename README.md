...
**Codex Helper v4.4.8**（GitHub Release，当前稳定版）：

- 精简安装包：`codex-helper-v4.4.8-setup.exe`（依赖 Windows x64 的 **.NET 8 Desktop Runtime**，安装 .NET 8 SDK 也可满足）
- [打开 v4.4.8 Release 页面](https://github.com/2909272751/codex-helper/releases/tag/v4.4.8)
- [直接下载精简安装包](https://github.com/2909272751/codex-helper/releases/download/v4.4.8/codex-helper-v4.4.8-setup.exe)
