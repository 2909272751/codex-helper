...
public partial class WelcomeWindow : Window
{
    ...
    [
        ...
        new("Collaboration", "协作开发：GPT 规划、Reasonix 编码", "协作开发独立于连接中心，集中管理 GPT + Reasonix 的协作设置。", "先点“开启协作编码”安装 Reasonix 执行 Skill，并确认状态显示已开启。随后可按需设置 Reasonix 默认模型、权限模式和执行强度，点“测试连接”确认可用。Codex 原生子智能体保持关闭，Reasonix 是独立执行器。", "最近 Reasonix 任务可在这里刷新、停止、重试或返回原 Codex 任务；首次启用或关闭协作后需重新打开 Codex。"),
